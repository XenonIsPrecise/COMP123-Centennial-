...
namespace Lab_Theatre
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Movies on Sunday");
            Console.WriteLine("=====================");
            ...
            Console.WriteLine("Cineplex");
            Console.WriteLine("Action, Romance movies");
            Console.WriteLine("===========================");

            eglinton.PrintShows(Genre.Action | Genre.Romance);  //displays 3 objects
            Console.WriteLine(" ");
            Console.WriteLine(" ");
            Console.WriteLine("Morgan Freeman movies");
            Console.WriteLine("========================");
            ...
            Console.WriteLine("Cineplex");
            Console.WriteLine("Movies @14:05");
            Console.WriteLine("=================");
            ...
            Console.WriteLine(" ");
            Console.WriteLine("Cineplex");
            Console.WriteLine("Sun movies @14:05");
            Console.WriteLine("=====================");
